...
<body>
    ...
    <script>
        ...
        <div class="content-fine-art">
            <h2 style="text-align: center; margin-top: 40px; margin-bottom: 20px;">FINE ART COLLECTION</h2>
            ...
            <div id="product-list" class="product-list">
                <?php
                    ...
                    // fetch SQL query to show only fine art products
                    $sql = "SELECT * FROM product WHERE product_category = 'Fine Art'";
